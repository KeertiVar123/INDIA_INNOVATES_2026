            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  onChange={handleStudentLoginEmailChange}
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  onChange={handleStudentSignupFullNameChange}
                  className="w-full pl-11 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:outline-none transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    onChange={handleStudentSignupEmailChange}
                    className="w-full pl-11 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:outline-none transition-all"
                    placeholder="student@example.com"
                    autoComplete="email"
                    spellCheck="false"
              ...
              <div>
                ...
                <div className="relative flex">
                  ...
                  <input 
                    ...
                    onChange={handleStudentSignupPhoneChange}
                    type="tel"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <SearchableSelect
                ...
                icon={BookOpen}
                showOther={true}
                onOtherChange={setStudentSignupCollegeOther}
                otherValue={studentSignupCollegeOther}
                id="signup-college"
              ...
              <SearchableSelect
                ...
                icon={MapPin}
                showOther={true}
                onOtherChange={setStudentSignupCityOther}
                otherValue={studentSignupCityOther}
                id="signup-city"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <SearchableSelect
                ...
                label={t.degree}
                showOther={true}
                onOtherChange={setStudentSignupDegreeOther}
                otherValue={studentSignupDegreeOther}
                id="signup-degree"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      id="signup-apaar"
                      type="text"
                      value={studentSignupApaarId}
                      onChange={handleStudentSignupApaarIdChange}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      id="signup-aadhaar"
                      type="text"
                      value={studentSignupAadhaar}
                      onChange={handleStudentSignupAadhaarChange}
                      className="w-full pl-11 pr-4 py-3 border-2 border-gray-200 bg-white rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:outline-none transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    onChange={handleStudentSignupPasswordChange}
                    type={showPassword ? "text" : "password"}
                    className="w-full pl-11 pr-11 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:outline-none transition-all"
                    placeholder="••••••••"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    onChange={handleStudentSignupConfirmPasswordChange}
                    className="w-full pl-11 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 focus:outline-none transition-all"
                    placeholder="••••••••"
                    autoComplete="new-password"
                    spellCheck="false"
            ...
            <button
              ...
              onClick={(e) => {
                ...
                if (!studentSignupFullName.trim()) {
                  alert('Please enter your full name');
                  return;
                }
                if (!studentSignupEmail.trim()) {
                  alert('Please enter your email address');
                  return;
                }
                if (!studentSignupPhone.trim()) {
                  alert('Please enter your phone number');
                  return;
                }
                if (!studentSignupCollege.trim() || (studentSignupCollege === 'Others' && !studentSignupCollegeOther.trim())) {
                  alert('Please select or enter your college/university');
                  return;
                }
                if (!studentSignupCity.trim() || (studentSignupCity === 'Others' && !studentSignupCityOther.trim())) {
                  alert('Please select or enter your city');
                  return;
                }
                if (!studentSignupDegree.trim() || (studentSignupDegree === 'Others' && !studentSignupDegreeOther.trim())) {
                  alert('Please select or enter your degree');
                  return;
                }
                if (!studentSignupYear.trim()) {
                  alert('Please select your year of study');
                  return;
                }

                // Validate APAAR ID (must be exactly 12 digits)
                if (!studentSignupApaarId.trim()) {
                  alert('Please enter your APAAR ID');
                  return;
                }
                if (studentSignupApaarId.length !== 12 || !/^\d{12}$/.test(studentSignupApaarId)) {
                  alert('APAAR ID must be exactly 12 digits');
                  return;
                }

                // Validate Aadhaar Number (must be exactly 12 digits)
                if (!studentSignupAadhaar.trim()) {
                  alert('Please enter your Aadhaar number');
                  return;
                }
                if (studentSignupAadhaar.length !== 12 || !/^\d{12}$/.test(studentSignupAadhaar)) {
                  alert('Aadhaar number must be exactly 12 digits');
                  return;
                }

                if (!studentSignupPassword.trim()) {
                  alert('Please enter a password');
                  return;
                }
                if (!studentSignupConfirmPassword.trim()) {
                ...
                setSignupUserData({
                  fullName: studentSignupFullName,
                  email: studentSignupEmail,
                  phone: countryCode + studentSignupPhone,
                  college: studentSignupCollege === 'Others' ? studentSignupCollegeOther : studentSignupCollege,
                  city: studentSignupCity === 'Others' ? studentSignupCityOther : studentSignupCity,
                  degree: studentSignupDegree === 'Others' ? studentSignupDegreeOther : studentSignupDegree,
                  year: studentSignupYear,
                  apaarId: studentSignupApaarId,
                  aadhaar: studentSignupAadhaar,
